        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-md-6">
                        <h5 class="card-title">Laporan Absensi Kantor Walikota | Kota Langsa</h5>
                    </div>
                </div>
                <div class="card-body">
                    @if (session('success'))
                    ...
                    @endif
                    <div class="row">
                        {{-- <a href="{{ route('attendance-print') }}" id="printPdf" target="_blank" class="btn btn-primary">Print</a> --}}
                        <div class="col-md">
                            <form action="{{ route('attendance-report-admin') }}" method="GET" class="form-inline my-2 my-lg-0 float-right">
                                <div class="input-group mb-3">
                                    <input type="text" id="created_at" name="date" class="form-control">
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="submit">Filter</button>
                                    </div>
                                    <a target="_blank" class="btn btn-primary ml-2" id="printPdf">Print PDF</a>
                                </div>
                            </form>
                            {{-- <form action="{{ route('attendance-report-admin') }}" method="GET" class="form-inline my-2 my-lg-0 float-right">
                                <div class="input-group mb-3">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#printPdf').attr('href', '/attendance-report-admin/print/' + start.format('YYYY-MM-DD') + '+' + end.format('YYYY-MM-DD'))
            ...
            $('#created_at').daterangepicker({
                ...
                $('#printPdf').attr('href', '/attendance-report-admin/print/' + first.format('YYYY-MM-DD') + '+' + last.format('YYYY-MM-DD'))
            })
        })
    </script>
@endsection